...
- **mcp2cli** by knowsuchagency · ★ 2.0k · Python MCP Server
...
- **openapi-to-cli** by EvilFreelancer · ★ 195 · TypeScript Codex Skill
  - Turns any OpenAPI/Swagger API into an CLI with set of commands. One CLI command per endpoint.
- **fusio** by apioo · ★ 2.1k · PHP MCP Server
  - Self-Hosted API Management for Builders
- **kubb** by kubb-labs · ★ 1.7k · TypeScript MCP Server
  - 🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.
- **open-trading-api** by koreainvestment · ★ 1.1k · Python MCP Server
