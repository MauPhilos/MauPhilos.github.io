...
## Quick Pick
[**clerkie-cli**](https://github.com/BerriAI/clerkie-cli) · ★ 97 · Clerkie-cli is a terminal tool that uses an LLM to help debug and troubleshoot c

## 工具列表

- [**clerkie-cli**](https://github.com/BerriAI/clerkie-cli) by BerriAI · ★ 97 · Python Agent Tool
...
- [**inspector**](https://github.com/MCPJam/inspector) by MCPJam · ★ 1.9k · TypeScript MCP Server
  - Development platform to debug, chat, inspect, and evaluate MCP servers, MCP apps, and ChatGPT apps.
- [**paperdebugger**](https://github.com/PaperDebugger/paperdebugger) by PaperDebugger · ★ 1.4k · TypeScript MCP Server
  - A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing
- [**Gearboy**](https://github.com/drhelius/Gearboy) by drhelius · ★ 1.1k · C++ MCP Server
...
- [**golf**](https://github.com/golf-mcp/golf) by golf-mcp · ★ 813 · Python MCP Server
  - Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents
- [**cheatengine-mcp-bridge**](https://github.com/miscusi-peek/cheatengine-mcp-bridge) by miscusi-peek · ★ 538 · Lua MCP Server
...
- [**opik-openclaw**](https://github.com/comet-ml/opik-openclaw) by comet-ml · ★ 506 · TypeScript Codex Skill
...
- [**Gearsystem**](https://github.com/drhelius/Gearsystem) by drhelius · ★ 357 · C++ MCP Server
  - Sega Master System / Game Gear / SG-1000 emulator, debugger and embedded MCP server for macOS, Windows, Linux, BSD and RetroArch.
- [**DebugMCP**](https://github.com/microsoft/DebugMCP) by microsoft · ★ 285 · TypeScript MCP Server
  - Gift your VS Code agent a real debugger: breakpoints, stepping, inspection.
- [**Geargrafx**](https://github.com/drhelius/Geargrafx) by drhelius · ★ 202 · C++ MCP Server
