...
- <a href="https://github.com/alibaba/open-code-review" target="_blank" rel="noopener"><strong>open-code-review</strong></a> by alibaba · ★ 19.9k · Go Agent Tool
  - Fast, efficient, battle-tested at Alibaba's scale. Hybrid architecture code review tool: deterministic pipelines + LLM Agent, precise line-level comments, built-in multi-language ruleset (NPE, thread-safety, XSS, SQL injection), OpenAI & Anthropic compatible.
- <a href="https://github.com/agavra/tuicr" target="_blank" rel="noopener"><strong>tuicr</strong></a> by agavra · ★ 2.4k · Rust Agent Tool
...
- <a href="https://github.com/waybarrios/opencode-power-pack" target="_blank" rel="noopener"><strong>opencode-power-pack</strong></a> by waybarrios · ★ 455 · Python MCP Server
