...
## Quick Pick
**shippie** · ★ 2.3k · extendable code review and QA agent 🚢

## 工具列表

- **shippie** by mattzcarey · ★ 2.3k · TypeScript MCP Server
  - extendable code review and QA agent 🚢
- **Claude-Command-Suite** by qdhenry · ★ 978 · Shell Claude Skill
...
- **tuicr** by agavra · ★ 476 · Rust Agent Tool
  - a terminal UI for local code review
- **maestro-orchestrate** by josstei · ★ 356 · JavaScript Codex Skill
  - Multi-agent orchestration platform for Gemini CLI, Claude Code, Codex, and Qwen Code — 22 specialists, parallel subagents, persistent sessions, and built-in code review, debugging, security, SEO, accessibility, and compliance tools
- **ai-review** by Nikita-Filonov · ★ 362 · Python Agent Tool
...
- **maestro-gemini** by josstei · ★ 259 · JavaScript Agent Tool
...
- **claude-night-market** by athola · ★ 258 · Python Claude Skill
...
- **plankton** by alexfazio · ★ 243 · Shell Agent Tool
...
- **Gito** by Nayjest · ★ 209 · Python Agent Tool
  - An AI-powered GitHub code review tool that uses LLMs to detect high-confidence, high-impact issues—such as security vulnerabilities, bugs, and maintainability concerns.
- **ring** by LerianStudio · ★ 175 · Python Agent Tool
